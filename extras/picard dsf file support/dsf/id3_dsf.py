...
import mutagen
from mutagen._util import DictProxy, cdata
    ...
    def load(self, filename, known_frames=None, translate=True):
        ...
        try:
            try:
                ...
                # try reading V1 ID3 the end of the file... no harm leaving this in.
                self.size = 0
                import sys
    ...
    def save(self, filename=None, v1=1):
        ...
        try:
            ...
            if id3_location == 0 : # we can make a new entry at the end of the file
                ...
                f.seek(20) # this is where we will store the pointer
            ...
            ## remove support for writing ID3v1 tags, DSF format does not support them
...
def delete(filename, delete_v1=True, delete_v2=True):
    ...
    ## DSF does not support ID3V1 but there should be no harm in leaving this in
    if delete_v1:
        try:
            f.seek(-128, 2)
        except IOError: pass
    ...
    if delete_v2:
        ...
        dsd_header = f.read(28)
        id3_location = cdata.ulonglong_le(dsd_header[20:28])
        f.seek(20) # go to ID3 pointer location and blank
