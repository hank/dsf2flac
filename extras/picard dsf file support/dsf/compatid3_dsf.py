...
from picard.plugins.dsf.id3_dsf import ID3, Frame, Frames, Frames_2_2, TextFrame, TORY, \
...
class CompatID3(ID3):
    """
    Additional features over picard.plugins.dsf.id3_dsf:
     * ID3v2.3 writing
     * iTunes' TCMP frame
    """
    ...
    def save(self, filename=None, v1=1, v2=4):
        ...
        Note that DSF does not support ID3V1 tags, v1 parameter is ignored.
        """
