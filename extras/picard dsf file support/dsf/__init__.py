...
PLUGIN_NAME = "DSF File Support"
PLUGIN_AUTHOR = "Jack Oclee-Brown"
PLUGIN_DESCRIPTION = "Tagging support for the DSF DSD Audio file format"
PLUGIN_VERSION = "0.1"
...
from picard.plugins.dsf.compatid3_dsf import CompatID3
...
class ID3File_DSF(File):
    ...
    def _save(self, filename, metadata, settings):
        ...
        try:
            tags = compatid3_dsf.CompatID3(encode_filename(filename))
